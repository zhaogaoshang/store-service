...
public interface TwoCategoryMapper {
    ...
    ArrayList<TwoCategory> selectByOneCategoryId(String oneCategoryId,Integer page); // 根据一级分类查找二级分类

    ArrayList<TwoCategory> selectByStoreId(String storeId); // 根据仓库id查找二级分类

    Integer selectByAllTwoCategory(String oneCategoryId); // 根据一级分类查找所有二级分类
